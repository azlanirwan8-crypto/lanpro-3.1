            ...
            <div className="p-6 pt-0 flex flex-col items-center text-center">
              <div className="mb-6 relative">
                ...
                <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M19 44L28 17L44 32L19 44Z" stroke="#0EA5E9" strokeWidth="3" strokeLinejoin="round"/>
                  <path d="M28 17C28 17 38 22 44 32" stroke="#0EA5E9" strokeWidth="3" strokeLinecap="round"/>
              ...
              <button
                onClick={onClose}
                className="px-6 py-2 bg-[#425287] hover:bg-[#34416a] text-white font-medium rounded-md transition-colors"
              >
                Tutup
              </button>
            </div>
