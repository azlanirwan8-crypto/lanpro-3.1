export const styles = {
  ...
  searchInput: "pl-9 pr-4 py-2 bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-700 rounded-md text-xs font-medium text-slate-700 dark:text-slate-200 w-full sm:w-64 placeholder:font-normal placeholder:text-slate-400 focus:ring-1 focus:ring-[#405189]/20 focus:border-[#405189] outline-none transition-all shadow-2xs",
  filterPill: "px-2.5 py-1 bg-indigo-50/80 dark:bg-indigo-950/20 text-[#405189] dark:text-indigo-400 border border-indigo-200/80 dark:border-indigo-900 rounded-md text-[10px] font-medium uppercase tracking-tight shadow-2xs",
  ...
  tableHeader: "bg-[#405189]/5 dark:bg-slate-950/50 border-b border-[#405189]/15 sticky top-0 z-10 shadow-2xs",
  tableHeaderCell: "group relative px-4 py-3 text-[11px] font-semibold text-[#405189] dark:text-slate-400 uppercase tracking-wider border-r border-[#405189]/10 dark:border-slate-800",
  ...
  selectedTableRow: "bg-[#405189]/5 dark:bg-[#405189]/20",
  ...
  inlineAddBorderedCell: "p-0 border-r border-slate-100/50 dark:border-slate-800 relative border-y-2 border-[#405189]",
