...
export const KpiMetricsRow: React.FC<KpiMetricsRowProps> = ({
  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 w-full h-full select-none">
      ...
      <div className="bg-surface dark:bg-slate-900 p-5 rounded-xl border border-border-subtle/60 dark:border-slate-800 hover:shadow-md transition-all relative overflow-hidden flex flex-col h-full shadow-soft group">
        ...
        <span className="text-xs sm:text-[10px] font-medium uppercase tracking-widest text-content-subtle dark:text-slate-500 mb-1">
          TOTAL COMPLETION
        </span>
        <div className="flex items-baseline gap-1.5 mt-auto">
          <span className="text-3xl font-medium text-content-strong dark:text-slate-100">
            {completionPercentage}%
          </span>
          <span className="text-xs font-medium text-content-subtle dark:text-slate-500">
            Stable
          </span>
        </div>
      </div>
      ...
      <div className="bg-surface dark:bg-slate-900 p-5 rounded-xl border border-border-subtle/60 dark:border-slate-800 hover:shadow-md transition-all relative overflow-hidden flex flex-col h-full shadow-soft group">
        ...
        <div className="flex items-baseline gap-1.5 mt-auto">
          <span className="text-3xl font-medium text-rose-600 dark:text-rose-400">
            {overdueTasks.length}
          </span>
      ...
      {/* Card 5: Team Size */}
      <div className="bg-surface dark:bg-slate-900 p-5 rounded-xl border border-border-subtle/60 dark:border-slate-800 hover:shadow-md transition-all relative overflow-hidden flex flex-col h-full shadow-soft group">
        <div className="w-10 h-10 rounded-xl bg-surface-muted dark:bg-slate-800 text-content-muted dark:text-slate-400 flex items-center justify-center mb-4 transition-transform group-hover:scale-105">
        ...
        <div className="flex items-baseline gap-1.5 mt-auto">
          ...
          <span className="text-xs font-medium text-content-subtle dark:text-slate-500">Users</span>
        </div>
      </div>
    </div>
  );
