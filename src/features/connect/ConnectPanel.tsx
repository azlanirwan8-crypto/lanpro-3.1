    ...
    <div className="flex flex-col h-full bg-surface-sunken/60 relative overflow-hidden">        
      <div className="flex-1 overflow-auto p-4 md:p-5 relative z-10 w-full space-y-4">
        ...
        <div className="bg-surface p-4 rounded-lg border border-emerald-200/80 shadow-2xs flex items-start gap-3">
          ...
          <div>
            <h3 className="text-xs font-medium text-content-strong uppercase tracking-wide">Active MySQL Connection Help</h3>
          ...
          <form onSubmit={handleTestConnection} className="p-4 md:p-5 space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-content-body">Database Host (DB_HOST)</label>
                <input 
                  name="host" 
                  value={config.host} 
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-content-body">Database Port (DB_PORT)</label>
                <input 
                  name="port" 
                  value={config.port} 
                  onChange={handleChange} 
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-medium text-content-body">Database Name (DB_NAME)</label>
              <input 
                name="database" 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-content-body">Password (DB_PASSWORD)</label>
                <input 
                  type="password"
                  name="password" 
