    ...
    <div className="flex-1 overflow-auto p-6 md:p-8 bg-surface-sunken animate-in fade-in duration-700 custom-scrollbar">
      <div className="space-y-6 w-full">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 border-b border-border-subtle pb-6 mb-2">
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={exportTasksToCSV} className="px-4 py-2.5 bg-indigo-600 border border-indigo-600 text-white rounded-xl text-xs font-medium shadow-soft-lg shadow-indigo-100 transition-all flex items-center gap-2 tracking-widest hover:bg-indigo-700 hover:-translate-y-0.5 active:scale-95 uppercase">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-surface p-6 rounded-xl border border-border-subtle shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col justify-between hover:shadow-md transition-shadow h-32 relative overflow-hidden">
              ...
              <div className="text-xs sm:text-[10px] font-medium tracking-[0.2em] uppercase text-content-subtle z-10 flex items-center gap-2"><Zap className="w-3.5 h-3.5" /> Total Events</div>
          ...
          <div className="bg-surface p-6 rounded-xl border border-border-subtle shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col justify-between hover:shadow-md transition-shadow h-32 relative overflow-hidden">
              ...
              <div className="text-xs sm:text-[10px] font-medium tracking-[0.2em] uppercase text-content-subtle z-10 flex items-center gap-2"><Users className="w-3.5 h-3.5" /> Active Actors (24h)</div>
          ...
          <div className="bg-surface p-6 rounded-xl border border-border-subtle shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col justify-between hover:shadow-md transition-shadow h-32 relative overflow-hidden">
              ...
              <div className="text-xs sm:text-[10px] font-medium tracking-[0.2em] uppercase text-content-subtle z-10 flex items-center gap-2"><Clock className="w-3.5 h-3.5" /> Last Event</div>
            ...
            <ResponsiveTable className="w-full text-left border-collapse min-w-[900px]">
              <thead className="bg-surface">
                <tr>
                  ...
                  <th className="px-8 py-5 text-xs sm:text-[10px] font-medium text-content-subtle uppercase tracking-[0.2em] border-b border-border-subtle">Event Signature</th>
                  <th className="px-8 py-5 text-xs sm:text-[10px] font-medium text-content-subtle uppercase tracking-[0.2em] border-b border-border-subtle">Subject (Actor)</th>
                  <th className="px-8 py-5 text-xs sm:text-[10px] font-medium text-content-subtle uppercase tracking-[0.2em] border-b border-border-subtle text-right">Audit Trail ID</th>
                </tr>
              </thead>
                ...
                {filteredLogs.map(log => {
                    ...
                    <tr key={log.id} className="hover:bg-surface-sunken border-b border-border-faint transition-colors group cursor-default">
                      <td className="px-8 py-5 whitespace-nowrap align-top">
                          ...
                          <div className="text-xs sm:text-[10px] font-medium text-content-subtle tabular-nums uppercase mt-1 tracking-widest">{safeFormat(log.createdAt, 'HH:mm:ss.SSS')}</div>
                      </td>
                                ...
                                <>
                                  ...
                                  <div className="flex-1 min-w-0">
                                    <div className="flex items-center gap-2 flex-wrap mb-2">
                                      <span className={`text-xs sm:text-[11px] sm:text-[9px] font-medium tracking-[0.15em] uppercase px-2 py-0.5 rounded shadow-soft ${badgeClass}`}>
                                        {log.action?.replace(/_/g, ' ') || 'ACTION_EXECUTED'}
                                      </span>
                                      <span className="text-xs sm:text-[10px] font-medium text-content-subtle capitalize px-1 ring-1 ring-slate-200 rounded-sm bg-surface-sunken">
                                        Source: UI
                                      </span>
                                    </div>
                      ...
                      <td className="px-8 py-5 min-w-[200px]">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col min-w-0">
                              ...
                              <span className="text-xs sm:text-[10px] font-medium text-content-muted truncate tracking-wide">{actor?.email}</span>
                            </div>
                        </div>
                      </td>
                      <td className="px-8 py-5 text-right w-48 align-middle">
                          <div className="flex flex-col items-end gap-1.5">
                            <div className="font-mono text-xs sm:text-[11px] sm:text-[9px] bg-surface-muted text-content-muted px-2 py-1 rounded border border-border-subtle uppercase font-medium tracking-widest select-all opacity-70 group-hover:opacity-100 transition-opacity" title={log.id}>
