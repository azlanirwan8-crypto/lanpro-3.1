                    ...
                    >
                      ...
                      {edge.label && (
                        <foreignObject
                          ...
                          height="26"
                        >
                          <div className="bg-surface border border-border-subtle text-xs sm:text-[11px] sm:text-[9px] text-content-strong font-medium px-1.5 py-0.5 rounded shadow-soft text-center truncate">
                            {edge.label}
                          </div>
                        </foreignObject>
                      )}
