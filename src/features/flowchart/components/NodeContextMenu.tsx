  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="w-full flex items-center gap-2.5 px-3 py-2 text-xs font-medium rounded-xl text-slate-700 hover:text-violet-600 hover:bg-violet-50 transition-colors text-left"
      >
      ...
      <button
        ...
        className="w-full flex items-center gap-2.5 px-3 py-2 text-xs font-medium rounded-xl text-slate-700 hover:text-indigo-600 hover:bg-indigo-50 transition-colors text-left"
      >
