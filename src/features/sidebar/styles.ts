export const styles = {
  aside: "fixed inset-y-0 left-0 z-50 transform md:translate-x-0 md:static bg-primary border-r border-[#364574] flex flex-col transition-all duration-300 text-[#abb9e8] select-none",
  asideMobileOpen: "translate-x-0 shadow-2xl",
  asideMobileClosed: "-translate-x-full",
  asideCollapsed: "md:w-20",
  asideExpanded: "md:w-64",
  collapseButton: "hidden md:absolute md:flex items-center justify-center -right-3 top-6 bg-[#364574] border border-[#4a5c96] rounded-full p-1.5 min-w-8 min-h-8 text-slate-200 hover:text-white shadow-md z-10 hover:scale-110 transition-transform cursor-pointer",
  ...
  logoText: "font-medium text-2xl tracking-widest text-white uppercase font-sans",
  ...
  newButton: "p-2 min-w-9 min-h-9 justify-center text-xs text-[#abb9e8] hover:text-white hover:bg-white/10 rounded transition-all flex items-center gap-1",
  projectButton: "w-full flex items-center py-2.5 min-h-11 rounded-md transition-all text-sm",
  projectButtonSelected: "bg-[#364574] text-white font-medium shadow-sm border-l-3 border-amber-400",
